        ...
        <div class="card-body">
            ...
            <form method="post" action="{{route('admin.page.edit.post',$page->id)}}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <label for="editor"></label><textarea id="editor" name="contentss" class="form-control" value="{!! $page->content !!}" rows="4">{!! $page->content !!}</textarea>
                </div>
                <div class="form-group">
                    <button type="submit" class="btn btn-primary btn-block">Deneme Güncelle</button>
                </div>
            </form>
        </div>
    </div>
